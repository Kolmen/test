...
Select the **IIS2ICLX** and choose the required parameters of the **MLC** and sensor. The chosen configuration of the sensor and MLC Output Data Rate (**ODR**) for this example is visible in the picture below:
...
The meta-classifier is not necessary for the purpose of this example, so it was left at 0 in both cases (decision tree #1 and decision tree #2).
